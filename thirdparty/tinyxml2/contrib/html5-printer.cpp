...
static const char input[] = "<html><body><p style='a'></p><br/>&copy;<col a='1' b='2'/><div a='1'></div></body></html>";
...
protected:
    ...
    virtual bool isVoidElement(const char* name) {
        ...
        // http://dev.w3.org/html5/markup/syntax.html
        static const char* list[] = { "area", "base", "br", "col", "command", "embed", "hr", "img", "input", "keygen", "link", "meta",
