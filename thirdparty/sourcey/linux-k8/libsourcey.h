...
#define SCY_VERSION "1.0.2"
#define SCY_VERSION_MAJOR 1
#define SCY_VERSION_MINOR 0
#define SCY_VERSION_PATCH 2

// Define the source path
#define SCY_SOURCE_DIR "/home/zippyai/sourcey/libsourcey/src"

// Define the build path
#define SCY_BUILD_DIR "/home/zippyai/sourcey/libsourcey/build"

// Define the installation path
#define SCY_INSTALL_DIR "/usr/local"

// Disable logging
#define SCY_ENABLE_LOGGING

// Building as shared library (.so or .dll)
/* #undef SCY_SHARED_LIBRARY */
