...
template <typename Model, int minimum_set_size, typename Data> class Ransac {
public:
    ...
    Model Compute(
        unsigned int num_elements, std::vector<int>& inliers, int iterations, double max_datum_fit_error, unsigned int min_consensus_size) {
