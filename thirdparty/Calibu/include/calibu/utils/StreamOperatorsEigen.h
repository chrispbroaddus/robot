...
template <typename T, int R, int C> inline std::ostream& operator<<(std::ostream& Stream, const Eigen::Matrix<T, R, C>& Mat) {
...
////////////////////////////////////////////////////////////////////////////
template <typename T, int R, int C> inline std::istream& operator>>(std::istream& Stream, Eigen::Matrix<T, R, C>& Mat) {
