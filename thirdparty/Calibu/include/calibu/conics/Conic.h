...
CALIBU_EXPORT
std::pair<Eigen::Vector3d, Eigen::Matrix3d> PlaneFromConics(const std::vector<Conic, Eigen::aligned_allocator<Conic>>& conics,
    double plane_circle_radius, const Eigen::Matrix3d& K, double inlier_threshold);
CALIBU_EXPORT
