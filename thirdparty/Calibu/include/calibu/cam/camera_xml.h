...
///////////////////////////////////////////////////////////////////////////////
template <class T> inline void StrToVal(T& t, const std::string& sValue) {
    std::istringstream iss(sValue);
    iss >> t;
}

///////////////////////////////////////////////////////////////////////////////
template <class T> inline T StrToVal(const std::string& sValue, const T& default_val = T()) {
    T t = default_val;
    std::istringstream iss(sValue);
    iss >> t;
    return t;
...
///////////////////////////////////////////////////////////////////////////////
template <class T> inline std::string ValToStr(const T& t) {
...
CALIBU_EXPORT
void WriteXmlCamera(std::ostream& out, const std::shared_ptr<CameraInterfaced> cam, int indent = 0);

CALIBU_EXPORT
void WriteXmlCamera(const std::string& filename, const std::shared_ptr<CameraInterfaced> cam);

////////////////////////////////////////////////////////////////////////////
inline void WriteXmlCameraAndTransformWithLut(
    std::ostream& out, std::string& sLutXmlElement, const std::shared_ptr<CameraInterfaced> cam, int indent = 0) {
...
///////////////////////////////////////////////////////////////////////////////
CALIBU_EXPORT
std::shared_ptr<CameraInterfaced> ReadXmlCamera(const std::string& filename, const std::shared_ptr<CameraInterfaced> cam);
...
CALIBU_EXPORT
void WriteXmlCameraAndTransform(std::ostream& out, const std::shared_ptr<CameraInterfaced> cop, int indent = 0);

CALIBU_EXPORT
void WriteXmlCameraAndTransform(const std::string& filename, const std::shared_ptr<CameraInterfaced> cop);

CALIBU_EXPORT
std::shared_ptr<CameraInterfaced> ReadXmlCameraAndTransform(const std::string& filename, const std::shared_ptr<CameraInterfaced> cop);

CALIBU_EXPORT
std::shared_ptr<CameraInterfaced> ReadXmlCameraAndTransform(const std::string& filename);
