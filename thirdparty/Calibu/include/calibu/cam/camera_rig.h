...
static const Sophus::SO3d RdfVision = Sophus::SO3d((Eigen::Matrix3d() << 1, 0, 0, 0, 1, 0, 0, 0, 1).finished());

static const Sophus::SO3d RdfRobotics = Sophus::SO3d((Eigen::Matrix3d() << 0, 0, 1, 1, 0, 0, 0, 1, 0).finished());

// T_2b_1b = T_ba * T_2a_1a * T_ab
template <typename Scalar = double>
inline Sophus::SE3Group<Scalar> ToCoordinateConvention(const Sophus::SE3Group<Scalar>& T_2a_1a, const Sophus::SO3Group<Scalar>& R_ba) {
