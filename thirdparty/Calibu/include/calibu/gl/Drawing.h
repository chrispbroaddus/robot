...
inline void glDrawRectPerimeter(const IRectangle& r) { pangolin::glDrawRectPerimeter(r.x1, r.y1, r.x2, r.y2); }
...
inline void glDrawTarget(
    const std::vector<int>& map, const TargetInterface& target, const Eigen::Vector2d& offset, double scale, double sat, double val) {
