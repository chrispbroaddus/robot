...
void ConicFinder::Find(const ImageProcessing& imgs) {
    ...
    FindCandidateConicsFromLabels(imgs.Width(), imgs.Height(), imgs.Labels(), candidates, params.conic_min_area, params.conic_max_area,
        params.conic_min_density, params.conic_min_aspect);
