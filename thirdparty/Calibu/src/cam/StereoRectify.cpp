...
std::shared_ptr<calibu::Rig<double>> CreateScanlineRectifiedLookupAndCameras(const Sophus::SE3d& T_rl,
    ...
    std::shared_ptr<calibu::CameraInterface<double>> new_cam_left(new calibu::LinearCamera<double>(params_, size_));
    new_cam_left->SetPose(Sophus::SE3d());
    std::shared_ptr<calibu::CameraInterface<double>> new_cam_right(new calibu::LinearCamera<double>(params_, size_));
